...
let VehiclesController = class VehiclesController {
    ...
    async findAll(categoria, condicion, destacado, search) {
        return this.vehiclesService.findAll({ categoria, condicion, destacado, search });
    }
    async findMyListings(req) {
    ...
    async create(req, createVehicleDto) {
        const user = req.user;
        return this.vehiclesService.create(createVehicleDto, user);
    }
    async update(id, req, updateVehicleDto) {
        const user = req.user;
...
__decorate([
    ...
    __param(1, (0, common_1.Query)('condicion')),
    __param(2, (0, common_1.Query)('destacado')),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], VehiclesController.prototype, "findMyListings", null);
__decorate([
    (0, common_1.Get)(':id'),
